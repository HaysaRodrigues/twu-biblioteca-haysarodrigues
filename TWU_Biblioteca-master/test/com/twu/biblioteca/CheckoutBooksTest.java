...
//    }
    ...
    @Test
    public void validateThat_checkoutBook_WillReturnAInvalidMessageWhenTheBookIsNotAvailable() {

        BooksManager booksManager = new BooksManager();
        Messages messages = new Messages();
        String bookIDToCheckAvailability = "13";
        List<Book> listBeforeCheckout;
        ...
        String message = booksManager.checkoutBook(bookIDToCheckAvailability);

        Assert.assertEquals(message, messages.showCheckoutNotAvailableBook());
